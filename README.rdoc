...
Creates, manages and searches aliases for class methods, instance methods, constants and
delegated methods via a YAML config file. Although the default alias types are created with
the irb user in mind, it's possible to create your own alias types.
...
* Provide a way autogenerate aliases with a given proc.
