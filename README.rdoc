...
If neither is the case, pass a :file option to create():

    Alias.create :file=>"/path/to/my/clandestine_aliases.yml"

If you'd like to define your aliases without a config file, pass Alias.create() a block and
