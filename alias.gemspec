...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "VERSION.yml", "README.rdoc", "LICENSE.txt", "aliases.yml.example", "lib/alias", "lib/alias/class_method_creator.rb", "lib/alias/console.rb", "lib/alias/constant_creator.rb", "lib/alias/core_extensions.rb", "lib/alias/creator.rb", "lib/alias/instance_method_creator.rb", "lib/alias/manager.rb", "lib/alias/method_creator_helper.rb", "lib/alias.rb", "lib/config_struct.rb", "test/alias_test.rb", "test/aliases.yml", "test/constant_creator_test.rb", "test/core_extensions_test.rb", "test/creator_test.rb", "test/manager_test.rb", "test/method_creator_helper_test.rb", "test/test_helper.rb"]
  s.has_rdoc = true
