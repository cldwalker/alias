...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "LICENSE.txt", "aliases.yml.example", "lib/alias", "lib/alias/class_method_creator.rb", "lib/alias/constant_creator.rb", "lib/alias/core_extensions.rb", "lib/alias/creator.rb", "lib/alias/instance_method_creator.rb", "lib/alias/manager.rb", "lib/alias.rb", "test/alias_creator_test.rb", "test/alias_manager_test.rb", "test/alias_test.rb", "test/aliases.yml", "test/core_extensions_test.rb", "test/test_helper.rb"]
  s.has_rdoc = true
